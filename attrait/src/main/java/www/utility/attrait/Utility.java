...
public class Utility {
	 ...
	 * @return 페이징 생성 문자열
	 */
	public static String pagingR(int totalRecord, int nPage, int recordPerPage, String url, int bbsno, int nowPage,
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (nPage == i) {
				...
				str.append("<span class='span_box_1'><A href='./" + url + "?nowPage=" + nowPage + "&col=" + col
						+ "&word=" + word + "&bbsno=" + bbsno + "&nPage=" + i + "'>" + i + "</A></span>");
			}
		}
		...
		if (nowGrp < totalGrp) {
			str.append("<span class='span_box_1'><A href='./" + url + "?nowPage=" + nowPage + "&col=" + col + "&word="
					+ word + "&bbsno=" + bbsno + "&nPage=" + _nowPage + "'>다음</A></span>");
		}
		str.append("</DIV>");
	...
	public static String spaging(String url, int totalRecord, int nowPage, int recordPerPage) {
		int pagePerBlock = 10;
		int totalPage = (int) (Math.ceil((double) totalRecord / recordPerPage));
		int totalGrp = (int) (Math.ceil((double) totalPage / pagePerBlock));
		int nowGrp = (int) (Math.ceil((double) nowPage / pagePerBlock));
		...
		str.append("  #paging {text-align: center; margin-top: 5px; font-size: 1em;}");
		str.append("  #paging A:link {text-decoration:none; color:black; font-size: 1em;}");
		str.append("  #paging A:hover{text-decoration:none; background-color: black; color:black; font-size: 1em;}");
		str.append("  #paging A:visited {text-decoration:none;color:black; font-size: 1em;}");
		str.append("  .span_box_1{");
		str.append("    text-align: center;");
		str.append("    font-size: 1em;");
		...
		int _nowPage = (nowGrp - 1) * pagePerBlock;
		if (nowGrp >= 2) {
			str.append("<span class='span_box_1'><A href='./" + url + "?nowPage=" + _nowPage + "'>이전</A></span>");
		}
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (nowPage == i) {
				...
				str.append("<span class='span_box_1'><A href='./" + url + "?nowPage=" + i + "'>" + i + "</A></span>");
			}
		}

		_nowPage = (nowGrp * pagePerBlock) + 1;
		if (nowGrp < totalGrp) {
			str.append("<span class='span_box_1'><A href='./" + url + "?nowPage=" + _nowPage + "'>다음</A></span>");
		}
